...
3. Download project from github(https://github.com/saipawar123/Blood-Bank-Managment-System.git).

   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/saipawar123/Blood-Bank-Managment-System.git
